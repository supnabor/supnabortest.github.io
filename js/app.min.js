"use strict";
"use strict";function initAnchorScrolling(){$('a[href*="#"]').not('[href="#"]').not('[href="#0"]').click((function(t){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var n=$(this.hash);(n=n.length?n:$("[name="+this.hash.slice(1)+"]")).length&&(t.preventDefault(),$("html, body").animate({scrollTop:n.offset().top},1e3,(function(){var t=$(n);if(t.focus(),t.is(":focus"))return!1;t.attr("tabindex","-1"),t.focus()})))}}))}function initHamburger(){var t=$(".burger-button"),n=$(".header-nav"),e=$(".header-link");function i(){[t,n].forEach((function(t){return t.toggleClass("active")}))}t.click(i),e.click(i)}$(document).ready((function(){$(".slider").slick({autoplay:!0,speed:1500})})),$(document).ready((function(){initHamburger(),initAnchorScrolling()}));
